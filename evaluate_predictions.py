...
# 加载预测结果文件 MultiOutputRegressor + 任意强模型
pred_file_path = 'new/CNN/CNN1/result_CNN1D_full_safe.csv'
# pred_file_path = 'CompareModle/DT/result_DT.csv'
pred_data = pd.read_csv(pred_file_path)

# 加载真实值数据集
true_file_path = "modified_数据集Time_Series662_detail.dat"
